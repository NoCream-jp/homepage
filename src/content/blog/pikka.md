...
ガクチカにもなるかと思い、毎月なにかアプリケーションを制作できればとシリーズ記事を書き始めた次第です。5月の制作記事としての公開になりますね。こうなってくると記事一覧画面にカテゴリでのフィルター機能がほしいところです。記事データにはすでに、それを見越して表に出ない"カテゴリ"プロパティを付与してはいるのですが、余裕があるときに実装しておきます。ではまた。

### 関連リンク

https://pikka.mi-nato.com
